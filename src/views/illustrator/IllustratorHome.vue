  ...
  <div id="illustratorhome">
    ...
    <div class="order-container">
      <b-table :data="false ? [] : orders" :striped = "true" :hoverable = "true" ref='table'>
        ...
        <b-table-column label="動作" v-slot="props" width="200">
    ...
    <div class="order-container">
      <b-table :data="false ? [] : doing" :striped = "true" :hoverable = "true" ref='table'>
...
export default {
  ...
  methods: {
    ...
    async submitRejectModal (event) {
      ...
      this.submitting = true
      try {
        await this.api.patch('/orders/cancel/' + this.form2._id, {
    ...
    async finish (index) {
      try {
        await this.api.patch('/orders/finish/' + this.doing[index]._id, {
          headers: {
            authorization: 'Bearer ' + this.user.token
          }
        })
